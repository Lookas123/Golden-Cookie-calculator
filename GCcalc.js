...
let chances = [1,1,0.03,0.03,dfactive?0.1:0.05,bs?0.25:0,0.0005,0.0001,dh?0.15:(rb?0.015:0),df?0.15:(rb?0.015:0),emg?0.05:0,0,0,0,0,0,0,0,0];
let wchances = [0,1,0.321,0.321,dfactive?0.1:0.05,bs?0.25:0,0.0005,0.0001,dh?0.05:(rb?0.005:0),df?0.05:(rb?0.005:0),emg?0.05:0,1,1,0.3,0.1,skruuia?1:0,skruuia?1:0,skruuia?1:0,skruuia?1:0]
let dchances=[];
let dwchances=[];
let basechances=[];
let basewchances=[];
